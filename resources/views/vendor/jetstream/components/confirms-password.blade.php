@props(['title' => __('Confirmar Senha'), 'content' => __('Para a sua segurança, por favor, confirme a sua senha para continuar.'), 'button' => __('Confirmar')])
...
<x-jet-dialog-modal id="confirmingPasswordModal">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="{{ $errors->has('confirmable_password') ? 'is-invalid' : '' }}" placeholder="{{ __('Senha') }}"
